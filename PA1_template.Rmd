...
plot(as.numeric(attributes(factor(data$interval))$levels), mean1_summary, type = 'l', xlab = 'Interval', ylab = 'Number of steps', xaxt = 'n', xlim = c(0, 2355))
...
```{r}
boxplot(mean_summary, new_mean_summary, median_summary, new_median_summary, xaxt ='n', ylab = 'Number of Steps', main = 'Box Plots')
axis(1, at = c(1, 2, 3, 4), labels = c('OriginalMean', 'ModifiedMean', 'OriginalMedian', 'ModifiedMedian'))
...
for (i in 1: length(days)){
  if (days[i] == "Monday" || days[i] == "Tuesday" ||days[i] == "Wednesday" || days[i] =="Thursday" || days[i] =="Friday"){
    days[i] <- 'weekday'
  }
...
plot(as.numeric(attributes(factor(data$interval))$levels), weekday_mean, type = 'l', xlab = 'Interval', ylab = 'Number of steps', xaxt = 'n', xlim = c(0, 2355), main = 'Weekday')
axis(1, at = c(0, 500, 1000, 1500, 2000))
plot(as.numeric(attributes(factor(data$interval))$levels), weekend_mean, type = 'l', xlab = 'Interval', ylab = 'Number of steps', xaxt = 'n', xlim = c(0, 2355), main = 'Weekend')
axis(1, at = c(0, 500, 1000, 1500, 2000))
```